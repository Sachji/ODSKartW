...
public interface KartManager {
     ...
     * @throws KartException if a category with the specified name already
     * exists
     */
     ...
     * @throws KartException if the category does not exist or if trying to
     ...
     * @throws KartException if the medium has more movies than the category
     * allows or if the medium has no movies
     */
