...
public class Category {
     ...
     * @param maxMediumMovies               the maximum number of movies for a medium, must be positive
    ...
    /** A getter method for the maximum number of movies for a medium in a category
     *
